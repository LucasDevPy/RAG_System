...
- Smart Chunking - Recursive text splitting with overlap for optimal context
- **🎯 Context Re-ranking** - Flashrank-powered relevance scoring for better answers
- **📎 Source Citations** - Every answer includes references to original PDFs
- **💬 Conversational Memory** - LangGraph maintains chat history across turns
- Embedding Cache - Reduces API costs with intelligent caching
